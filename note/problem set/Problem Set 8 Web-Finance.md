# [Problem Set 8 Web-Finance](https://cs50.harvard.edu/x/2020/tracks/web/finance/)
---

### 題目說明
在Finance中,我們要製作一個股票買賣網站,此網站具備以下幾種功能
* 註冊帳號
* 登入/登出
* 修改密碼
* 增加手持金額
...
### Answer
因為此題檔案較多,故這裡只放上主要的python程式`application.py`,`helper.py`及DB schema並加上註解說明,其他檔案請直接上[CS50-GitHub](https://github.com/me50/xupmtp/tree/cs50/problems/2020/x/tracks/web/finance)上查看

##### application.py
controller+service功能,URL轉發給前端使用
```python
import os
...
CREATE TABLE IF NOT EXISTS 'holdStock'(
'userid' INTEGER NOT NULL,
'symbol' TEXT NOT NULL,
